...
RustCrypto を Nim から安全に呼び出すための FFI ラッパーです。現時点では SHA-256、HMAC-SHA256、HKDF-SHA256、secp256k1 公開鍵導出、ECDSA 署名・検証、SHA3-256、Keccak-256、Ed25519 の PKCS#8/SPKI 変換を提供しています。
...
- Ed25519 PKCS#8 / SPKI RFC 8410 の既知ベクトル
- `SHA3-256("abc")`
- `Keccak-256("abc")`
