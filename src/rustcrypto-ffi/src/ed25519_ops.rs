use crate::{
    aead_common, ED25519_PRIVATE_KEY_LEN, ED25519_PUBLIC_KEY_LEN, ED25519_SIGNATURE_LEN,
    RUSTCRYPTO_ERR_INVALID_PUBLIC_KEY_FORMAT, RUSTCRYPTO_ERR_INVALID_SECRET_KEY,
    RUSTCRYPTO_ERR_INVALID_SIGNATURE, RUSTCRYPTO_ERR_NULL_OUTPUT,
...
mod tests {
    ...
    fn public_key_from_secret_key_matches_rfc_8032_vector() {
        ...
        assert_eq!(
            &output,
            hex_bytes("d75a980182b10ab7d54bfed3c964073a0ee172f3daa62325af021a68f707511a").as_slice()
        );
    }
